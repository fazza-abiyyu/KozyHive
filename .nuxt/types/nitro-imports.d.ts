declare global {
  ...
  const addToBlacklist: typeof import('../../server/utils/TokenBlacklist')['addToBlacklist']
  ...
  const decodeAccessToken: typeof import('../../server/utils/jwt')['decodeAccessToken']
  const decodeRefreshToken: typeof import('../../server/utils/jwt')['decodeRefreshToken']
  ...
  const deleteRefreshToken: typeof import('../../server/utils/jwt')['deleteRefreshToken']
  ...
  const generateAccessToken: typeof import('../../server/utils/jwt')['generateAccessToken']
  ...
  const isBlacklisted: typeof import('../../server/utils/TokenBlacklist')['isBlacklisted']
  ...
  const sendRefreshToken: typeof import('../../server/utils/jwt')['sendRefreshToken']
